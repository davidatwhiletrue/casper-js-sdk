...
export declare class Contract {
     ...
     */
    constructor(contractPackageHash: ContractPackageHash, contractWasmHash: ContractHash, entryPoints: NamedEntryPoint[], namedKeys: NamedKeys, protocolVersion: string);
}
