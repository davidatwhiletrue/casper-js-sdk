...
import { InfoGetTransactionResult, PutDeployResult, PutTransactionResult, RpcClient } from '../rpc';
import { Args, PublicKey, Transaction, TransactionHash } from '../types';
export declare class CasperNetwork {
    ...
    getTransaction(hash: TransactionHash): Promise<InfoGetTransactionResult>;
}
